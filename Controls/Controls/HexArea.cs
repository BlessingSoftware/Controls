...
namespace BlessingSoftware.Controls {
    [TemplatePart(Name = "PART_ColumnHeader", Type = typeof(IScrollable))]
    [TemplatePart(Name = "PART_HexView", Type = typeof(HexView))]
    ...
    public class HexArea :Control, IScrollInfo {
        ...
        public static readonly DependencyProperty LineHeightProperty =
            DependencyProperty.Register("LineHeight", typeof(double), typeof(HexArea), new FrameworkPropertyMetadata(12.0d));

        public static readonly DependencyProperty ColumnWidthProperty =
            DependencyProperty.Register("ColumnWidth", typeof(double), typeof(HexArea), new FrameworkPropertyMetadata(24.0d));

        public static readonly DependencyProperty ColumnHeightProperty =
            DependencyProperty.Register("ColumnHeight", typeof(double), typeof(HexArea), new FrameworkPropertyMetadata(24.0d));


        public static readonly DependencyProperty LineOffsetProperty =
            DependencyProperty.Register("LineOffset", typeof(int), typeof(HexArea), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.AffectsRender));
